...
{
    if (freq_new == DVFS_F1) /* set ARMPLL divider to 1/1 */
    {
    ...
    else if (freq_new == DVFS_F2) /* set ARMPLL divider to 5/6 */
    {
    ...
    else if (freq_new == DVFS_F3) /* set ARMPLL divider to 3/4 */
    {
        if (freq_new > freq_old)
        {
            #ifdef MTK_BUCK_ADJUST
    ...
    else if (freq_new == DVFS_F4) /* set ARMPLL divider to 2/3 */
    {
        if (freq_new > freq_old)
        {
            #ifdef MTK_BUCK_ADJUST
    ...
    else if (freq_new == DVFS_F5) /* set ARMPLL divider to 1/2 */
    {
        if (freq_new > freq_old)
        {
            #ifdef MTK_BUCK_ADJUST
    ...
    else if (freq_new == DVFS_F6) /* set ARMPLL divider to 1/4 */
    {
        if (freq_new > freq_old)
        {
            #ifdef MTK_BUCK_ADJUST
    ...
    else if (freq_new == DVFS_F7) /* set ARMPLL divider to 1/6 */
    {
        g_cur_freq = DVFS_F7;
    ...
    else /* set ARMPLL divider to 1/1 */
    {
...
void cpufreq_thermal_protect(unsigned int limited_freq)
{
    if (!g_enable_dvfs)
        return;
